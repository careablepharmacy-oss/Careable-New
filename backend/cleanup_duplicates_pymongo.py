"""
Production database cleanup using PyMongo (synchronous)
This should work if pymongo is installed (usually is for FastAPI+MongoDB apps)
"""
import sys
import os
...
def cleanup_duplicates():
    """Remove duplicate users safely using PyMongo"""
