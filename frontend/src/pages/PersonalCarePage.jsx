...
const PersonalCarePage = () => {
  ...
  const fetchProducts = async () => {
    try {
      setLoading(true);
      const data = await apiService.get('/api/products?category=personal_care');
      setProducts(data);
    } catch (error) {
  ...
  const fetchSubcategories = async () => {
    try {
      const data = await apiService.get('/api/products/subcategories?category=personal_care');
      ...
      <div className="bg-gradient-to-r from-[#1E3A5F] via-[#2BA89F] to-[#7AB648] p-4 sticky top-0 z-40">
        <div className="flex items-center justify-between mb-3">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-xl font-bold text-white">Personal Care</h1>
              <p className="text-green-100 text-xs">{filteredProducts.length} products</p>
            </div>
          </div>
          <Button 
            variant="ghost" 
            ...
            <div className="overflow-y-auto flex-1 min-h-0">
              ...
              <div className="p-5">
                {selectedProduct.subcategory && (
                  <p className="text-sm text-green-600 font-medium">{selectedProduct.subcategory}</p>
                )}
